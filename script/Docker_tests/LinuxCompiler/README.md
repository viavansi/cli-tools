...
NOTE: Compilation works for some reason; however, the steps followed to compile (written below; take a look!) I believe are not wrong. Need further investigation.
## Build your project
