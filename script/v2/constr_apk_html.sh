...
#TODO:check aapt dir
AAPT_VER="33.0.0-rc2"
AAPT_DIR="${HOME}/Library/Android/sdk/build-tools/${AAPT_VER}/aapt"
#holds the name of the first apk. There shouldn't be more than one, right?
apk=(*.apk)
